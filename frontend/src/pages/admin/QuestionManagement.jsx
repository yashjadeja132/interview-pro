...
export default function QuestionManagement() {
  ...
  const renderQuestionCard = (question) => (
    <Card key={question._id} className="group border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-200 bg-white">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex gap-1 ml-4">
            ...
            <Button 
              ...
              className="h-8 w-8 p-0 text-red-600 hover:bg-red-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
        ...
        <div className="mb-4">
          {question.questionImage ? (
            <div className="mb-3">
              ...
              />
              <div className="w-full h-40 bg-gray-100 rounded-lg border border-gray-200 flex items-center justify-center text-gray-500 text-sm" style={{display: 'none'}}>
    ...
    <>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Organize and manage questions by position for your interviews</p>
          </div>
            ...
            {selectedPosition && (
              <div className="mt-6 pt-6 border-t border-gray-100">
                <div className="flex items-center gap-6 text-sm text-gray-600">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span>Position: <span className="font-medium text-gray-900">{positions.find(p => p._id === selectedPosition)?.name}</span></span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                    <span>Questions: <span className="font-medium text-gray-900">{filteredQuestions.length}</span></span>
                  </div>
                  {searchTerm && (
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                      <span>Searching: <span className="font-medium text-gray-900">"{searchTerm}"</span></span>
                    </div>
                  )}
                </div>
              </div>
      ...
      <Dialog open={showViewDialog} onOpenChange={setShowViewDialog}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-xl font-bold">Question Details</DialogTitle>
          </DialogHeader>
          {selectedQuestion && (
            <div className="space-y-6">
              {/* Position Badge */}
                ...
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                  {selectedQuestion.questionImage && (
                    <div className="mb-4">
                      ...
                      />
                      <div className="w-full h-32 bg-gray-100 rounded-lg border border-gray-200 flex items-center justify-center text-gray-500 text-sm" style={{display: 'none'}}>
                        <div className="text-center">
                          <ImageIcon className="w-8 h-8 mx-auto mb-2 text-gray-400" />
                          <p>Image not available</p>
                        </div>
                      ...
                      <div className="ml-8">
                        {option.optionImage ? (
                          <div className="space-y-2">
                            ...
                            />
                            <div className="w-full h-24 bg-gray-100 rounded border border-gray-200 flex items-center justify-center text-gray-500 text-sm" style={{display: 'none'}}>
                              <div className="text-center">
                            ...
                            {option.optionText && (
                              <p className="text-sm text-gray-700 mt-2">{option.optionText}</p>
                            )}
                          </div>
                        ) : (
